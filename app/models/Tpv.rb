...
module Redsys
  class Tpv
    ...
    def merchant_signature_3des
      Base64.strict_encode64(encrypt_3DES(@order, Base64.strict_decode64('sq7HjrUOBfKmC576ILgskD5srU870gJ7')))
    end
    ...
    private
      ...
      def calculate_key
        ...
        encrypt_3DES(@order, Base64.urlsafe_decode64('sq7HjrUOBfKmC576ILgskD5srU870gJ7'))
      end
